...
<body>
    <div class="container">
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="font-medium text-heading">Status</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        $status = 'active';
                                        $statusText = 'Active';
                                        // يمكنك إضافة منطق لتحديد الحالة بناءً على بيانات أخرى
                                ...
                                <td>
                                    ...
                                    @if (Auth::user()->is_admin)
                                        ...
                                        <a href="{{ route('employees.trashed', $employee->id) }}"
                                            class="edit-link ml-2">Delete</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
        ...
        @if (Auth::user()->is_admin)
            <a href="{{ route('employees.create') }}" class="add-button">+ Add New Employee</a>
        @endif
    </div>
