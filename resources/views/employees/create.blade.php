...
<body>
    <!-- تضمين الهيدر من الصفحة الرئيسية -->
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select id="mgr_id" name="mgr_id" class="form-control" required>
                                <option value="">Select Manager</option>
                                @foreach($managers as $manager)
                                    <option value="{{ $manager->id }}" {{ old('mgr_id') == $manager->id ? 'selected' : '' }}>
    ...
    <!-- تضمين الفوتر من الصفحة الرئيسية -->
