...
<body>
    ...
    <div class="container">
        ...
        <div class="category-search-container">
            <form action="{{ route('categories.index') }}" method="GET" class="search-form">
                <div class="search-input-group">
                    ...
                    >
                    @if(request('search'))
                        <a href="{{ route('categories.index') }}" class="clear-search-btn" title="Clear search">
        ...
        @if ($categories->count() > 0)
            <!-- Search Results Info (For initial page load) -->
            @if(request('search'))
            ...
            <div class="empty-state">
                ...
                @if(request('search'))
                    ...
                    <div style="margin-top: 2rem; display: flex; gap: 1rem; justify-content: center;">
                        <a href="{{ route('categories.index') }}" class="btn-cancel" style="display: inline-flex;">
