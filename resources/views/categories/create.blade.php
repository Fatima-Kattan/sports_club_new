...
<head>
    ...
    <title>Create New Category - Fitness Club</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p>Add a new sports category to your fitness club</p>
        </div>
        ...
        <div class="form-card">
            <form action="{{ route('categories.store') }}" method="POST" id="categoryForm">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" required placeholder="Enter detailed description of the category...">{{ old('description') }}</textarea>
