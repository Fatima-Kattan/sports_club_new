...
<head>
    ...
    <title>Fitness Club - Confirm Password</title>
...
<body>
    <div class="container">
        ...
        <div class="card">
            <!-- Header -->
            <div class="header">
                <h2><i class="fas fa-shield-alt"></i> Confirm Password</h2>
            ...
            <form method="POST" action="{{ route('password.confirm') }}">
                ...
                <button type="submit" class="submit-btn">
                    <i class="fas fa-check" style="margin-right: 10px;"></i> CONFIRM
                </button>
            </form>

            <!-- Back Link -->
            <div class="login-link" style="margin-top: 20px;">
                <p><a href="javascript:history.back()" class="login-link-text">
