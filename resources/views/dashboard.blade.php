...
<body>
                ...
                <li>
                    <a href="{{ route('dashboard') }}" class="nav-link active">
                        <svg fill="#05C1F7" height="64px" width="64px" version="1.1" id="Capa_1"
                            ...
                            viewBox="-78.44 -78.44 483.73 483.73" xml:space="preserve" stroke="#05C1F7"
                            transform="rotate(0)">
                ...
                <li>
                    <a href="{{ route('employees.index') }}" class="nav-link" target="content-frame"
                        ...
                        <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                            <circle cx="12" cy="7" r="4"></circle>
                            <path d="M12 11l2.5 4-2.5 5-2.5-5 2.5-4z"></path>
                        </svg>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const farmStyle = document.querySelector('.farm_style');
            ...
            if (!isCollapsed) {
                ...
                if (farmStyle) farmStyle.classList.add('expanded');
            }
            ...
            menuToggle.addEventListener('click', function() {
                ...
                if (farmStyle) {
                    if (isNowCollapsed) {
                        farmStyle.classList.add('expanded');
                    } else {
                        farmStyle.classList.remove('expanded');
                    }
                }
            });
        });
